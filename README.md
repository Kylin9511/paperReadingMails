...
|  011  |  2018.11.23  | 模型研究 | _AutoAugment: Learning Augmentation Policies from Data_ <br>自动数据增强(Auto Augment)算法，利用更高级的数据增强涨点。| [URL](https://github.com/luzhilin19951120/paperReadingMails/tree/master/2018/010) |